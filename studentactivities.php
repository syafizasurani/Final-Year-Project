...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-indigo w3-card" id="myNavbar">
            <a href="menupage.php" class="w3-bar-item w3-button w3-bold"> < &nbsp Student Activities</a>
            <a href="confirmation_committee_2.php" class="w3-bar-item w3-button">Club Programme</a>
            <a href="confirmation_committee_1.php" class="w3-bar-item w3-button">Add New Programme</a>
    ...
    <div class="w3-container w3-white" style="padding:350px 0px">
        <div class="w3-display-middle w3-card" style="width:70%">
            ...
            <div id="Activities" class="w3-container w3-white w3-padding-16 myLink">
                <h3 class="w3-left w3-bold">List of Programme</h3><br>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($result = mysqli_fetch_array($querydisplay)){
                                ?>
                                <tr>
                                    <!-- <td> <img src=" <?php echo $result['prog_poster']; ?> " height="100px" width="100px"> </td> -->
                                    ...
                                    <td style="text-align:center">
                                        <a class='btn btn-success btn-sm viewbtn' href="view_details.php?view=<?php echo $result['id']; ?>">View Details</a>
                                    </td>
                                </tr>                            
                                <?php
                            }
