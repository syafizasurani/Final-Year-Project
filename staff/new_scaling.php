...
<html lang="en">
<head>
    <title>New Scaling Appointment</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <h4 style="padding:30px 0px">Dental > Scaling Appointment</h4>
        <div class=" w3-light-grey w3-container w3-padding" style="border-radius:20px">
            <div style="margin-top:10px">
                <form action="server/add_scaling.php" method="POST" enctype="multipart/form-data">
                    <?php
                    ...
                    ?>
                    <div class="w3-center">
                        <h4 style="font-weight: bold;">Book Appointment for Scaling Service</h4><br>
                    </div>
