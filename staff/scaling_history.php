...
<body>
    ...
    <div class="w3-container w3-white" style="padding:150px 200px">
        <div class="w3-center w3-container" style="padding-top:10px; padding-bottom:10px">
            <h4><b>Scaling Appointment History</b></h4>
        </div>
        <div class="w3-display w3-center w3-padding w3-container">
            <form class="search w3-padding-16" action="scaling_history.php" method="POST">
                ...
                <tbody>
                    <?php 
                        if(isset($_POST['search_scaling'])){
                            ...
                            $query = "SELECT * FROM scaling_history WHERE `matric_no` LIKE  '%".$valueToSearchScaling."%'";
                            $search_results_scaling = filterTable_scaling($query);
                        }
                        else{
                            $query = "SELECT * FROM scaling_history";
                            $search_results_scaling = filterTable_scaling($query);
                        }
