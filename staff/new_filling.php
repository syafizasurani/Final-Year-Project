...
<html lang="en">
<head>
    <title>New Filling Appointment</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <h4 style="padding:30px 0px">Dental > Filling Appointment</h4>
        <div class=" w3-light-grey w3-container w3-padding" style="border-radius:20px">
            <div style="margin-top:10px">
                <form action="server/add_filling.php" method="POST" enctype="multipart/form-data">
                    <?php
                    ...
                    ?>
                    <div class="w3-center">
                        <h4 style="font-weight: bold;">Book Appointment for Filling Service</h4><br>
                    </div>
                    <div class="form-details">
                        <h5>Please fill in all the details</h5>
                        <div class="form-group" style="padding: 5px 0px">
                            <label>Service</label>
                            <input type="text" class="form-control" value="Dental - Filling" placeholder="" name="service" readonly>
                        </div>
                        <div class="form-group" style="padding: 5px 0px">
                            <label>Date</label>
