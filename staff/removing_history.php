...
<body>
    ...
    <div class="w3-container w3-white" style="padding:150px 200px">
        <div class="w3-center w3-container" style="padding-top:10px; padding-bottom:10px">
            <h4><b>Removing Appointment History</b></h4>
        </div>
        <div class="w3-display w3-center w3-padding w3-container">
            <form class="search w3-padding-16" action="removing_history.php" method="POST">
                ...
                <tbody>
                    <?php 
                        if(isset($_POST['search_removing'])){
                            ...
                            $query = "SELECT * FROM removing_history WHERE `matric_no` LIKE  '%".$valueToSearchRemoving."%'";
                            $search_results_removing = filterTable_removing($query);
                        }
                        else{
                            $query = "SELECT * FROM removing_history";
                            $search_results_removing = filterTable_removing($query);
                        }
