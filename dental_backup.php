...
<body>
    ...
    <div class="w3-container w3-white" style="padding:80px 80px">
        <div class="w3-left" style="padding-top:10px; padding-bottom:10px">
            <h3><b>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp PKU Dental Service</b></h3>
        </div>
        <div class="w3-display w3-center w3-padding">
            <img class="w3-image w3-card" src="image/clinic2.png" alt="Dental" width="1190" height="200">
        </div>
        ...
        <div class="w3-container" style="padding:140px 50px;">
            <div class="w3-display-bottommiddle w3-card" style="width:65%; height:63%;">
                ...
                <div id="Operation Time" class="w3-container w3-white myLink">
                    <h3 class="w3-center" style="color:green; letter-spacing: 4px;"><b>OPEN EVERYDAY</b></h3>
                    <h3 class="w3-center" style="color:#CBCE22;"><b>8.00 am - 5.00 pm</b></h3>
                    <div class="desciption" style="padding: 2px 80px">
                        <h5 class="w3-left">Attention to all patient, 
                        <br><br>Below are the estimation time of dental services:</h5>
                    </div>
                    <div class="w3-row-padding w3-center" style="margin-top:20px">
                        <div class="w3-quarter" style="margin-top:20px">
                            <h4><b>Filling</b></h4>
                            <p class="">(Tampalan)</p>
                            <h4 style="color:blue">30 - 40 min</h4>
                        </div>
                        <div class="w3-quarter" style="margin-top:20px">
                            <h4><b>Removing</b></h4>
                            <p class="">(Cabutan)</p>
                            <h4 style="color:blue">30 - 50 min</h4>
                        </div>
                        <div class="w3-quarter" style="margin-top:20px">
                            <h4><b>Scaling</b></h4>
                            <p class="">(Cuci Gigi)</p>
                            <h4 style="color:blue">20 - 40 min</h4>
                        </div>
                        <div class="w3-quarter" style="margin-top:20px">
                            <h4 style="color:red"><b>Emergency Case</b></h4>
                            <p class="">(Kecemasan)</p>
                            <h4 style="color:blue">10 - 15 min</h4>
                        </div>
                    </div>
                    <div class="desciption" style="margin-top:20px">
                        <h5 class="w3-center">Your waiting time also depends on the number of patients who are waiting to receive 
                        <br><br>treatment from the time you register</h5>
                    </div>
                </div>
                <!-- Tabs Services-->
                <div id="Services" class="w3-container w3-white myLink">
                    <div class="w3-row-padding w3-center" style="margin-top:10px">
                        <div class="w3-quarter" style="margin-top:10px">
                            ...
                            <p style="margin-top:10px; padding:0px 20px">Filling service only available in counter.</p>
                            <p style="color:#29A714; padding:0px 20px"><b>Please refer to PKU counter to book your appointment</b></p>
                            <p style="padding:0px 30px">OR<br>Contact us for further information: Tel: +604-928 2460 / 2525</p>
                        </div>
                        <div class="w3-quarter" style="margin-top:10px">
                            <h4><b>Removing</b></h4>
                            <p class="">(Cabutan)</p>
                        ...
                        <div class="w3-quarter" style="margin-top:10px">
                            ...
                            <p class="">(Cuci Gigi)</p>
                            <hr class="w3-border-grey" style="margin:auto; width:90%">
                            <p style="margin-top:10px; padding:0px 20px">Available everyday. Book your appointment now.</p>
                            <p style="padding:0px 30px">OR<br>Contact us for further information: Tel: +604-928 2460 / 2525</p>
                            <div class="w3-display-bottom w3-white" style="size: 5px 5px; margin-top:30px">
                        ...
                        <div class="w3-quarter" style="margin-top:10px">
                            ...
                            <p class="">(Kecemasan)</p>
                            <hr class="w3-border-grey" style="margin:auto; width:90%">
                            <p style="margin-top:10px; padding:0px 20px">Special case only.<br></p>
                            <p style="color:#29A714; padding:0px 20px"><b><br>Please refer to PKU counter to book your appointment</b></p>
                            <p style="padding:0px 30px">OR<br>Contact us for further information: Tel: +604-928 2460 / 2525</p>
                        </div>
                </div>
            </div>
