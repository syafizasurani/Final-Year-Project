    ...
    <h4 style="padding:30px 0px">Dental > Scaling Appointment</h4>
        <div class=" w3-light-grey w3-container w3-padding" style="border-radius:20px">
            <div style="margin-top:10px">
                <form action="server/add_appt.php" method="POST" enctype="multipart/form-data">
                    <?php
                    if(isset($_SESSION['status_book'])){
                        ?>
                        <div class="alert">
                            <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
                            <strong>Success.</strong> <?php echo $_SESSION['status_book']; ?>
                        </div>
                        <?php
